...
3. **Build docs:** Update/create relevant `COGO/Build/*`.
4. **Scaffold:** Minimal runnable slice (e.g. entry + health); `.gitignore` for env/artifacts; **no real secrets**—`example-env.md` names only.
5. **Baseline:** How to run/test/lint; top 3 next tasks.
6. **Out:** Stack summary; touched files; open decisions.
